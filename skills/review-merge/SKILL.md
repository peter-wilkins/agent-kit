...
- Do not merge unless the user explicitly asked for merge or approve-and-merge.
...
- No production deploy, database migration, or environment mutation is hidden inside the PR.
